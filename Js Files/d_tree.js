...
d3.json("age_day_tree.json").then(function(data) {
  generate(data, "#chart1");
});

d3.json("gradyear_week_tree.json").then(function(data) {
  generate(data, "#chart2");
});

d3.json("age_channel_tree.json").then(function(data) {
  generate(data, "#chart3");
});

d3.json("timesent_content_tree.json").then(function(data) {
  generate(data, "#chart4");
});

d3.json("popularity_Day_tree.json").then(function(data) {
  generate(data, "#chart5");
});

d3.json("school_channel_tree.json").then(function(data) {
  generate(data, "#chart6");
});

d3.json("channel_content_tree.json").then(function(data) {
